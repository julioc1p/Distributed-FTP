...
p1 = Thread(target=create_dht_chord, args=('localhost', 23250))
p2 = Thread(target=create_dht_chord, args=('localhost', 23252, 'localhost', 23250))
p3 = Thread(target=create_dht_chord, args=('localhost', 23254, 'localhost', 23250))
